...
fileprivate extension NSTouchBar.CustomizationIdentifier {
	static let customizationIdentifier = "com.henryefranks.touchbar.customizationIdentifier"
}

@available(OSX 10.12.2, *)
fileprivate extension NSTouchBarItem.Identifier {
	static let identifier = NSTouchBarItem.Identifier("com.henryefranks.touchbar.items.identifier")
}
